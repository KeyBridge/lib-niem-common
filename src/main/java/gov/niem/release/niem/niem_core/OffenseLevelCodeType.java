...
@XmlType(name = "OffenseLevelCodeType", propOrder = {
  "value"
})
public class OffenseLevelCodeType {

  @XmlValue
  protected OffenseLevelCodeSimpleType value;
  ...
  public OffenseLevelCodeSimpleType getValue() {
    return value;
  }

  public void setValue(OffenseLevelCodeSimpleType value) {
    this.value = value;
  }
