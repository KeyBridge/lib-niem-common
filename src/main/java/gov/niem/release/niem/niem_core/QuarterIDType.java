...
@XmlType(name = "QuarterIDType", propOrder = {
  "value"
})
public class QuarterIDType {

  @XmlValue
  protected int value;
  @XmlAttribute(name = "yearFirstMonthDate", namespace = "http://release.niem.gov/niem/niem-core/4.0/")
  @XmlSchemaType(name = "gMonth")
  protected XMLGregorianCalendar yearFirstMonthDate;
  ...
  public XMLGregorianCalendar getYearFirstMonthDate() {
    return yearFirstMonthDate;
  }

  public void setYearFirstMonthDate(XMLGregorianCalendar value) {
    this.yearFirstMonthDate = value;
  }
