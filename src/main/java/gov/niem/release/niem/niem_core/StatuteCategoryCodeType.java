...
@XmlType(name = "StatuteCategoryCodeType", propOrder = {
  "value"
})
public class StatuteCategoryCodeType {

  @XmlValue
  protected StatuteCategoryCodeSimpleType value;
  ...
  public StatuteCategoryCodeSimpleType getValue() {
    return value;
  }

  public void setValue(StatuteCategoryCodeSimpleType value) {
    this.value = value;
  }
