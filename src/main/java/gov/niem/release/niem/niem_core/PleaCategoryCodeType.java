...
@XmlType(name = "PleaCategoryCodeType", propOrder = {
  "value"
})
public class PleaCategoryCodeType {

  @XmlValue
  protected PleaCategoryCodeSimpleType value;
  ...
  public PleaCategoryCodeSimpleType getValue() {
    return value;
  }

  public void setValue(PleaCategoryCodeSimpleType value) {
    this.value = value;
  }
