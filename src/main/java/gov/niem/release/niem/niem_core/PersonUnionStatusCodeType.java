...
@XmlType(name = "PersonUnionStatusCodeType", propOrder = {
  "value"
})
public class PersonUnionStatusCodeType {

  @XmlValue
  protected PersonUnionStatusCodeSimpleType value;
  ...
  public PersonUnionStatusCodeSimpleType getValue() {
    return value;
  }

  public void setValue(PersonUnionStatusCodeSimpleType value) {
    this.value = value;
  }
