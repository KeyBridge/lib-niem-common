...
@XmlType(name = "SupervisionRestrictionCodeType", propOrder = {
  "value"
})
public class SupervisionRestrictionCodeType {

  @XmlValue
  protected SupervisionRestrictionCodeSimpleType value;
  ...
  public SupervisionRestrictionCodeSimpleType getValue() {
    return value;
  }

  public void setValue(SupervisionRestrictionCodeSimpleType value) {
    this.value = value;
  }
