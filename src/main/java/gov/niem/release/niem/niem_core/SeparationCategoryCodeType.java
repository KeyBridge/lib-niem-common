...
@XmlType(name = "SeparationCategoryCodeType", propOrder = {
  "value"
})
public class SeparationCategoryCodeType {

  @XmlValue
  protected SeparationCategoryCodeSimpleType value;
  ...
  public SeparationCategoryCodeSimpleType getValue() {
    return value;
  }

  public void setValue(SeparationCategoryCodeSimpleType value) {
    this.value = value;
  }
