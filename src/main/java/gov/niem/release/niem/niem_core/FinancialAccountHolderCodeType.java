...
@XmlType(name = "FinancialAccountHolderCodeType", propOrder = {
  "value"
})
public class FinancialAccountHolderCodeType {

  @XmlValue
  protected FinancialAccountHolderCodeSimpleType value;
  ...
  public FinancialAccountHolderCodeSimpleType getValue() {
    return value;
  }

  public void setValue(FinancialAccountHolderCodeSimpleType value) {
    this.value = value;
  }
