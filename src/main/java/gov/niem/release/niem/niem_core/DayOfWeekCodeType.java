...
@XmlType(name = "DayOfWeekCodeType", propOrder = {
  "value"
})
public class DayOfWeekCodeType {

  @XmlValue
  protected DayOfWeekCodeSimpleType value;
  ...
  public DayOfWeekCodeSimpleType getValue() {
    return value;
  }

  public void setValue(DayOfWeekCodeSimpleType value) {
    this.value = value;
  }
