...
@XmlType(name = "ImagePoseCodeType", propOrder = {
  "value"
})
public class ImagePoseCodeType {

  @XmlValue
  protected ImagePoseCodeSimpleType value;
  ...
  public ImagePoseCodeSimpleType getValue() {
    return value;
  }

  public void setValue(ImagePoseCodeSimpleType value) {
    this.value = value;
  }
