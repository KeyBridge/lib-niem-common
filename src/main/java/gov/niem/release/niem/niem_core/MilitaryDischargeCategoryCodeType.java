...
@XmlType(name = "MilitaryDischargeCategoryCodeType", propOrder = {
  "value"
})
public class MilitaryDischargeCategoryCodeType {

  @XmlValue
  protected MilitaryDischargeCategoryCodeSimpleType value;
  ...
  public MilitaryDischargeCategoryCodeSimpleType getValue() {
    return value;
  }

  public void setValue(MilitaryDischargeCategoryCodeSimpleType value) {
    this.value = value;
  }
