...
@XmlType(name = "ContactInformationAvailabilityCodeType", propOrder = {
  "value"
})
public class ContactInformationAvailabilityCodeType {

  @XmlValue
  protected ContactInformationAvailabilityCodeSimpleType value;
  ...
  public ContactInformationAvailabilityCodeSimpleType getValue() {
    return value;
  }

  public void setValue(ContactInformationAvailabilityCodeSimpleType value) {
    this.value = value;
  }
