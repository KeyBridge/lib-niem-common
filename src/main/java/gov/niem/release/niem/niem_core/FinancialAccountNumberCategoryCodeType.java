...
@XmlType(name = "FinancialAccountNumberCategoryCodeType", propOrder = {
  "value"
})
public class FinancialAccountNumberCategoryCodeType {

  @XmlValue
  protected FinancialAccountNumberCategoryCodeSimpleType value;
  ...
  public FinancialAccountNumberCategoryCodeSimpleType getValue() {
    return value;
  }

  public void setValue(FinancialAccountNumberCategoryCodeSimpleType value) {
    this.value = value;
  }
