...
@XmlType(name = "PassportCategoryCodeType", propOrder = {
  "value"
})
public class PassportCategoryCodeType {

  @XmlValue
  protected PassportCategoryCodeSimpleType value;
  ...
  public PassportCategoryCodeSimpleType getValue() {
    return value;
  }

  public void setValue(PassportCategoryCodeSimpleType value) {
    this.value = value;
  }
