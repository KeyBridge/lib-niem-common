...
@XmlType(name = "BinaryHashFunctionCodeType", propOrder = {
  "value"
})
public class BinaryHashFunctionCodeType {

  @XmlValue
  protected BinaryHashFunctionCodeSimpleType value;
  ...
  public BinaryHashFunctionCodeSimpleType getValue() {
    return value;
  }

  public void setValue(BinaryHashFunctionCodeSimpleType value) {
    this.value = value;
  }
