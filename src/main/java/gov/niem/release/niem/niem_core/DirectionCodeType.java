...
@XmlType(name = "DirectionCodeType", propOrder = {
  "value"
})
public class DirectionCodeType {

  @XmlValue
  protected DirectionCodeSimpleType value;
  ...
  public DirectionCodeSimpleType getValue() {
    return value;
  }

  public void setValue(DirectionCodeSimpleType value) {
    this.value = value;
  }
