...
@XmlType(name = "PersonNameCategoryCodeType", propOrder = {
  "value"
})
public class PersonNameCategoryCodeType {

  @XmlValue
  protected PersonNameCategoryCodeSimpleType value;
  ...
  public PersonNameCategoryCodeSimpleType getValue() {
    return value;
  }

  public void setValue(PersonNameCategoryCodeSimpleType value) {
    this.value = value;
  }
