...
@XmlType(name = "AddressCategoryCodeType", propOrder = {
  "value"
})
public class AddressCategoryCodeType {

  @XmlValue
  protected AddressCategoryCodeSimpleType value;
  ...
  public AddressCategoryCodeSimpleType getValue() {
    return value;
  }

  public void setValue(AddressCategoryCodeSimpleType value) {
    this.value = value;
  }
