package gov.niem.release.niem.codes.iso_4217;
...
public class CurrencyCodeType {
  ...
  @XmlValue
  protected CurrencyCodeSimpleType value;
  ...
  public CurrencyCodeSimpleType getValue() {
    return value;
  }

  public void setValue(CurrencyCodeSimpleType value) {
    this.value = value;
  }
