...
@XmlType(name = "DEAClassScheduleCodeCodeType", propOrder = {
  "value"
})
public class DEAClassScheduleCodeCodeType {

  @XmlValue
  protected DEAClassScheduleCodeCodeSimpleType value;
  ...
  public DEAClassScheduleCodeCodeSimpleType getValue() {
    return value;
  }

  public void setValue(DEAClassScheduleCodeCodeSimpleType value) {
    this.value = value;
  }
