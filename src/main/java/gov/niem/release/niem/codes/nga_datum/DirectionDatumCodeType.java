...
@XmlType(name = "DirectionDatumCodeType", propOrder = {
  "value"
})
public class DirectionDatumCodeType {

  @XmlValue
  protected DirectionDatumCodeSimpleType value;
  ...
  public DirectionDatumCodeSimpleType getValue() {
    return value;
  }

  public void setValue(DirectionDatumCodeSimpleType value) {
    this.value = value;
  }
