...
@XmlType(name = "TelephoneCategoryCodeType", propOrder = {
  "value"
})
public class TelephoneCategoryCodeType {

  @XmlValue
  protected TelephoneCategoryCodeSimpleType value;
  ...
  public TelephoneCategoryCodeSimpleType getValue() {
    return value;
  }

  public void setValue(TelephoneCategoryCodeSimpleType value) {
    this.value = value;
  }
