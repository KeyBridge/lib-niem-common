...
@XmlType(name = "USStateCodeType", propOrder = {
  "value"
})
public class USStateCodeType {

  @XmlValue
  protected USStateCodeSimpleType value;
  ...
  public USStateCodeSimpleType getValue() {
    return value;
  }

  public void setValue(USStateCodeSimpleType value) {
    this.value = value;
  }
