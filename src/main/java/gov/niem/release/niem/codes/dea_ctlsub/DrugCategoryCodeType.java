...
@XmlType(name = "DrugCategoryCodeType", propOrder = {
  "value"
})
public class DrugCategoryCodeType {

  @XmlValue
  protected DrugCategoryCodeSimpleType value;
  ...
  public DrugCategoryCodeSimpleType getValue() {
    return value;
  }

  public void setValue(DrugCategoryCodeSimpleType value) {
    this.value = value;
  }
