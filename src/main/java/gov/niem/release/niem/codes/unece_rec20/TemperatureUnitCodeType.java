...
@XmlType(name = "TemperatureUnitCodeType", propOrder = {
  "value"
})
public class TemperatureUnitCodeType {

  @XmlValue
  protected TemperatureUnitCodeSimpleType value;
  ...
  public TemperatureUnitCodeSimpleType getValue() {
    return value;
  }

  public void setValue(TemperatureUnitCodeSimpleType value) {
    this.value = value;
  }
