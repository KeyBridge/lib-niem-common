...
@XmlType(name = "CanadianProvinceCodeType", propOrder = {
  "value"
})
public class CanadianProvinceCodeType {

  @XmlValue
  protected CanadianProvinceCodeSimpleType value;
  ...
  public CanadianProvinceCodeSimpleType getValue() {
    return value;
  }

  public void setValue(CanadianProvinceCodeSimpleType value) {
    this.value = value;
  }
