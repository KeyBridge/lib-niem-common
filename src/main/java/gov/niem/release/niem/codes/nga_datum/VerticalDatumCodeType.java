...
@XmlType(name = "VerticalDatumCodeType", propOrder = {
  "value"
})
public class VerticalDatumCodeType {

  @XmlValue
  protected VerticalDatumCodeSimpleType value;
  ...
  public VerticalDatumCodeSimpleType getValue() {
    return value;
  }

  public void setValue(VerticalDatumCodeSimpleType value) {
    this.value = value;
  }
